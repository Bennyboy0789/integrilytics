      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between gap-8">
        <div>
          ...
          <div className="mt-5 flex gap-4">
            <a href="https://www.facebook.com/IntegriLytics/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-blue-300 hover:text-white transition-colors">
            ...
            <a href="https://www.instagram.com/integrilytics/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-blue-300 hover:text-white transition-colors">
            ...
            <a href="https://www.linkedin.com/company/integrilyticsinc" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-blue-300 hover:text-white transition-colors">
            ...
            <a href="https://www.tiktok.com/@integrilytics" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-blue-300 hover:text-white transition-colors">
            ...
            <a href="https://www.youtube.com/@integrilytics" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-blue-300 hover:text-white transition-colors">
